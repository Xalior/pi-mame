...
**PARKED** — same box class as ep64 (identical config and flags). The capture above shows the observed stop; the machine is not offered until the park is lifted by a policy ruling.

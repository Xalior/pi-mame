...
- MAME clone of `ar_fast` (Magic Johnson's Fast Break (Arcadia, V 2.8)) — the system macro's parent field in the driver source. The ROM table above lists every member this machine's own zip needs.

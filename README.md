...
- **Sixteen platforms, 198 machines.** Each platform is a family of machines
...
| Sega — the Out Run arcade board and the games built on it | 5 | [docs/sega/](docs/sega/README.md) |

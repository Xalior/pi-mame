...
make -j"$(getconf _NPROCESSORS_ONLN)" \
    ...
    OSD=sdl \
    SUBTARGET=spectrum \
    SOURCES=src/mame/sinclair/spectrum.cpp,src/mame/sinclair/spec128.cpp,src/mame/sinclair/next/specnext.cpp,src/mame/sinclair/specpls3.cpp,src/mame/sinclair/zx.cpp,src/mame/sinclair/timex.cpp,src/mame/sinclair/pentagon.cpp,src/mame/sinclair/scorpion.cpp,src/mame/sinclair/atm.cpp,src/mame/sinclair/evo/pentevo.cpp,src/mame/sinclair/evo/tsconf.cpp,src/mame/sinclair/elwro800.cpp,src/mame/sinclair/byte.cpp,src/mame/amstrad/amstrad.cpp \

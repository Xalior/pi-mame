...
# (720x576).
case "$MACHINE" in
    ts2068|ts1000|ts1500|c64|c64_jp|c64c|sx64|dx64|pet64|edu64|vic20|vic1001|c264|plus4|c16|v364|bbcb_us|a400|a800|a600xl|a800xl|a65xe|a800xe|xegs) CANVAS=cmdline-ntsc.txt ;;
